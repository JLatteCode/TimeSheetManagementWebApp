...
public class TimesheetRow implements java.io.Serializable {
    ...
    /** Holds the value hours of each day in a week. */
    ...
    /**
     * Getter for totalWeekHours.
     * @return totalWeekHours
     */
    public float getTotalWeekHours() {
        return totalWeekHours;
    }

    /**
     * Setter for totalWeekHours.
     * @param totalWeekHours a float
     */
